...
//                ]
    ...
    public function heuristic_eval()
    {
        $heuristics = [
          ...
          ['title' => 'Aesthetic and minimalist design', 'description'=>'Dialogs should not contain information that is irrelevant or rarely needed. Every extra unit of information in a dialog competes with the relevant units of information and diminishes their relative visibility.'],
          ['title' => 'Help users recognize, diagnose and recover from errors', 'description'=>'Error messages should be expressed in plain language (no codes), precisely indicate the problem, and constructively suggest a solution.'],
          ['title' => 'Help and documentation', 'description'=>'Few systems can be used with no instructions so it may be necessary to provide help and documentation. Any such information should be easy to search, focussed on the user’s task, list concrete steps to be carried out, and not be too large.'],
        ];
        $results = [
