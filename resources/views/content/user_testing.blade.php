...
@section('post_body')
    ...
    <div class="text-center image-box">
        <div class="row">
            <div class="flex-column">
                <img src="{{ asset('images/Users/interview/1.jpg') }}" title='interview_1'>
                <img src="{{ asset('images/Users/interview/2.jpg') }}" title='interview_2'>
            </div>
            <div class="flex-column">
                <img src="{{ asset('images/Users/interview/3.jpeg') }}" title='interview_3'>
                <img src="{{ asset('images/Users/interview/4.jpeg') }}" title='interview_4'>
            </div>
        </div>
    </div>
    <hr><br>
    ...
    <div class="text-center image-box">
        <div class="row">
            <div class="flex-column">
                <img src="{{ asset('images/Users/observation/1.jpg') }}" title='observation_1'>
                <img src="{{ asset('images/Users/observation/2.jpeg') }}" title='observation_2'>
            </div>
            <div class="flex-column">
                <img src="{{ asset('images/Users/observation/3.jpeg') }}" title='observation_3'>
                <img src="{{ asset('images/Users/observation/4.jpg') }}" title='observation_4'>
            </div>
            <div class="flex-column">
                <img src="{{ asset('images/Users/observation/5.jpg') }}" title='observation_5'>
            </div>
        </div>
    </div>
    <br><hr>
